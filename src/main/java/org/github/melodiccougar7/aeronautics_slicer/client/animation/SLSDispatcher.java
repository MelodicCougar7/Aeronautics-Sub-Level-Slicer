...
public class SLSDispatcher {
    private static final AzCommand IDLE_COMMAND = AzCommand.create("base_controller", "NONE", AzPlayBehaviors.PLAY_ONCE);
    ...
    public static void idling(Entity entity, ItemStack itemStack) {
        IDLE_COMMAND.sendForItem(entity, itemStack);
    }

    public static void active(Entity entity, ItemStack itemStack) {
        ACTIVE_COMMAND.sendForItem(entity, itemStack);
    }

    public static void windUp(Entity entity, ItemStack itemStack) {
        WIND_UP_COMMAND.sendForItem(entity, itemStack);
    }

    public static void windDown(Entity entity, ItemStack itemStack) {WIND_DOWN_COMMAND.sendForItem(entity, itemStack);}
